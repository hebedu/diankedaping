...
import { Bot, Home, BookOpen, User, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="h-14 bg-panel border-b border-border flex items-center justify-between px-4 z-20 shadow-sm relative">
      ...
      <div className="flex items-center space-x-5">
        ...
        <div className="flex items-center space-x-1 text-muted hover:text-text cursor-pointer transition-colors text-sm mr-2">
